...
function perder() {
    if (rodadas_restantes == 0) {
        id("game-box").remove()
        id("winner-loser").src = "img/loser.png"
        id("winner-loser").style.height = "251px";
    }
}
...
function ganhador() {
    if (visibility(1) == "hidden" && visibility(2) == "hidden" && visibility(3) == "hidden" && visibility(4) == "hidden" && visibility(5) == "hidden" && visibility(6) == "hidden" && visibility(7) == "hidden" && visibility(8) == "hidden" && visibility(9) == "hidden" && visibility(10) == "hidden" && visibility(11) == "hidden" && visibility(0) == "hidden" && rodadas_restantes == 7) {
        id("game-box").remove() = "hidden", id("winner-loser").src = "img/perfect.png", id("winner-loser").style.height = "233px";
    } else if (visibility(1) == "hidden" && visibility(2) == "hidden" && visibility(3) == "hidden" && visibility(4) == "hidden" && visibility(5) == "hidden" && visibility(6) == "hidden" && visibility(7) == "hidden" && visibility(8) == "hidden" && visibility(9) == "hidden" && visibility(10) == "hidden" && visibility(11) == "hidden" && visibility(0) == "hidden") {
        id("game-box").remove(), id("winner-loser").src = "img/winner.png", id("winner-loser").style.height = "229px";
    }
}
